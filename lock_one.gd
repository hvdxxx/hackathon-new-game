...
@onready var main_hero: AnimatedSprite2D = $MainHero/AnimatedSprite2D
@onready var dog_one: AnimatedSprite2D = $LittleDog_one/AnimatedSprite2D
@onready var dog_two: AnimatedSprite2D = $LittleDog_two/AnimatedSprite2D
